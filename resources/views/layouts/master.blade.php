                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ asset('assets/user3-128x128.jpg') }}" alt="User Avatar" class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
...
<script type="text/javascript">
    $(function() {
        ...
        $("#creatNewStudent").click(function() {
            $("#student_id").val("");
        ...
        $("body").on("click", ".deleteStudent", function() {
            ...
            confirm("Areyou sure you want to delete!");
            $.ajax({
                type: "DELETE",
                data: {
                    _token: "{{csrf_token()}}",
        ...
        $("body").on("click", ".editStudent", function() {
            var student_id = $(this).data("id");
            $.get(
                "{{ route('students.index') }}" + "/" + student_id + "/edit",
                function(data) {
